...
function potencia($potencia1, $potencia2, $potencia3, $potencia4){
...
//
        ...
        function direcao($d1, $d2, $d3=null, $d4=null){
            ...
            if ($direcoes[$d1]['peso'] > $direcoes[$d2]['peso']) {
...
//        $melhorpot = potencia(200, 140, 78, 120);
